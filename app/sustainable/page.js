        ...
        <>
            ...
            <section className="bg-gradient-to-b from-[#ffffff] to-[#ECF9FF]">
                <div className="container mx-auto  py-20 text-center space-y-10">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-5 justify-items-center py-10 pb-20">
                    ...
                    <KnowledgeHub 
                        imageSrc="/images/Sustainability/Sustainable.webp"
                        imageAlt="sustainable"
                        tagline="Sustainable Updates"
                        title="Knowledge Hub"
                        description="We're always finding new ways to reach and exceed our sustainability goals. Explore our latest reports for more insights."
