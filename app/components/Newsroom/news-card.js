            ...
            <Link href={`/newsroom/${post.slug || post.id}`}>
                <div className="relative aspect-video overflow-hidden">
                    <Image 
                        ...
                        fill
                        className="object-cover max-h-[300px] rounded-[20px] transition-transform duration-300 hover:scale-105"
                        onError={(e) => {
                ...
                <div className="p-5">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <BsArrowUpRightSquareFill className="text-primary lg:text-4xl text-2xl rounded-[10px]" />
                    </div>
                </div>
            </Link>
        </div>
