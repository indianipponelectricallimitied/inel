            ...
            <div className="container mx-auto">
                ...
                >
                    {programs.map((program, programIndex) => (
                        <SwiperSlide key={programIndex}>
                            <div className="group   w-full h-[400px] relative transition-all flex items-end justify-center duration-500 bg-cover bg-center rounded-[20px] overflow-hidden" 
