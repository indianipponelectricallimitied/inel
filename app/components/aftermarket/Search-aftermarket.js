...
export default function SearchAftermarket() {
    ...
    return (
        ...
        <div className="grid-with-gradients">
            ...
            <section className="rounded-[20px] relative z-20 bg-gradient-to-br from-[#F6F6F6] to-[#ffffff00]">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="relative">
                                <select 
                                    ...
                                    className="w-full bg-white rounded-md py-3 px-4 appearance-none"
                                >
                                ...
                                <div className="absolute right-2 top-1/2 -translate-y-1/2 w-7 h-7 flex items-center justify-center bg-[#160959] rounded-md">
