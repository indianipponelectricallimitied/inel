...
export default function StockDataCard({background}) {
  ...
  const manualNSEData = {
    'Global Quote': {
      ...
      '05. price': '993.00', // Updated price
      '09. change': '-4.50', // Updated change
      '10. change percent': '-0.45%',
      '07. latest trading day': '2024-10-28T15:30:00'
    }
  };
  ...
  const manualBSEData = {
    'Global Quote': {
      ...
      '05. price': '992.40', // Updated price
      '09. change': '-6.05', // Updated change
      '10. change percent': '-0.61%',
      '07. latest trading day': '2024-10-28T15:30:00'
    }
  };
