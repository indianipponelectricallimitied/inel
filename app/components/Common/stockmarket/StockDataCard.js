...
export default function StockDataCard({background}) {
  ...
  const manualNSEData = {
    'Global Quote': {
      ...
      '05. price': '1049.05', // 29 Sep close
      '09. change': '-38.65', // vs 25 Sep close (946.70)
  ...
  const manualBSEData = {
    'Global Quote': {
      ...
      '05. price': '857.35', // 29 Sep close
      '09. change': '-228.80', // vs 25 Sep close (940.00)
      '10. change percent': '-21.068%',
      '07. latest trading day': '2025-10-08T15:30:00'
    }
  };
